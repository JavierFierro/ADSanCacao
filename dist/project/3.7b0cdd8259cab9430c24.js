...
let DatosPersonalesComponent = /*@__PURE__*/ (() => {
    class DatosPersonalesComponent {
        ...
        downloadVerificacion() {
            ...
            // console.log(this.formulariosVerificacion[0].fechaVisita)
            this.open();
        ...
        downloadLineaBase() {
            // console.log(this.id)
            this.agriService.descargarLineaBase(this.id, this.datosPersonales.get("nombre").value, this.formulariosVerificacion[0].fechaVisita);
        }
        createCelularField() {
...
const _c0 = ["canvas"];
function CanvasComponent_button_5_Template(rf, ctx) {
    if (rf & 1) {
...
function CanvasComponent_button_8_Template(rf, ctx) {
    if (rf & 1) {
