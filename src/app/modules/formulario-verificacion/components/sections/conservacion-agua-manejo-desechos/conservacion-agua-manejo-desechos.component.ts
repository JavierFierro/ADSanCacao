...
export class ConservacionAguaManejoDesechosComponent implements OnInit {
  ...
  constructor(
    ...
    this.conservacionAguaManejoDesechos = this.formBuilder.group({
      ...
      tieneDisenoFijo: new FormControl(''),
      tieneDisenoMovible: new FormControl(''),
      hectareasDisenioRiegoFijo: new FormControl(''),
      hectareasDisenioRiegoMovible: new FormControl(''),
  ...
  disenoRiegoFijo(): boolean {
    const disenoRiego = this.conservacionAguaManejoDesechos.get('disenioRiego').value;
    return disenoRiego.includes('FIJO');
  }

  disenoRiegoMovible(): boolean {
    const disenoRiego = this.conservacionAguaManejoDesechos.get('disenioRiego').value;
    return disenoRiego.includes('MOVIBLE');
  }
  ...
  clasificaBasuraDomestica(): boolean {
    return this.conservacionAguaManejoDesechos.get('clasificaBasuraDomestica').value === 'SI';
  }
        ...
        tieneDisenoFijo: {
          ...
          preguntas: {
            hectareasDisenioRiegoFijo: {
              respuesta: this.conservacionAguaManejoDesechos.value.hectareasDisenioRiegoFijo
            }
          }
        },
        tieneDisenoMovible: {
          ...
          preguntas: {
            hectareasDisenioRiegoMovible: {
              respuesta: this.conservacionAguaManejoDesechos.value.hectareasDisenioRiegoMovible
            }
          }
        },
  ...
  setValues(formularioVerificacion: FormularioVerificacion): void {
    ...
    this.conservacionAguaManejoDesechos.get('tieneDisenoFijo')
      .setValue(formularioVerificacion.secciones.conservacionAguaManejoDesechos.preguntas.tieneDisenoFijo.respuesta);
    this.conservacionAguaManejoDesechos.get('tieneDisenoMovible')
      .setValue(formularioVerificacion.secciones.conservacionAguaManejoDesechos.preguntas.tieneDisenoMovible.respuesta);
    this.conservacionAguaManejoDesechos.get('hectareasDisenioRiegoFijo')
      .setValue(formularioVerificacion.secciones.conservacionAguaManejoDesechos.preguntas.tieneDisenoFijo.preguntas.hectareasDisenioRiegoFijo.respuesta);
    this.conservacionAguaManejoDesechos.get('hectareasDisenioRiegoMovible')
      .setValue(formularioVerificacion.secciones.conservacionAguaManejoDesechos.preguntas.tieneDisenoMovible.preguntas.hectareasDisenioRiegoMovible.respuesta);
